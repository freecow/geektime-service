...
tail -f /var/log/logstash/logstash-plain.log
# 预期输出
[2022-12-03T01:32:19,260][INFO ][logstash.javapipeline    ][main] Pipeline started {"pipeline.id"=>"main"}
[2022-12-03T01:32:19,359][INFO ][logstash.agent           ] Pipelines running {:count=>1, :running_pipelines=>[:main], :non_running_pipelines=>[]}
[2022-12-03T01:32:19,387][INFO ][org.logstash.beats.Server][main][bfe127e3210072bf0a55fe357144684028a8358fda9d65e0a25cb397c989bc7b] Starting server on port: 5044
...
tail -f /var/log/logstash/logstash-plain.log
# 预期输出
[2022-12-03T03:57:54,827][INFO ][logstash.inputs.redis    ][main] Registering Redis {:identity=>"redis://<password>@172.16.17.2:6379/0 list:develop-app1-accesslog"}
[2022-12-03T03:57:54,840][INFO ][logstash.javapipeline    ][main] Pipeline started {"pipeline.id"=>"main"}
[2022-12-03T03:57:55,019][INFO ][org.logstash.beats.Server][main][a83c37afb2e83f46ae01d0c1f57460db1c8a72f0d1bcd5bcda96b17f3c68dad3] Starting server on port: 5044
[2022-12-03T03:57:55,075][INFO ][logstash.agent           ] Pipelines running {:count=>1, :running_pipelines=>[:main], :non_running_pipelines=>[]}
...
![image-20221203120027354](assets/image-20221203120027354.png)
